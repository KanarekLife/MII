...
public class PlayerController_193319 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            GameManager_193319.instance.AddPoints(1);
        ...
        {
            GameManager_193319.instance.AddKey();
            other.gameObject.SetActive(false);
        ...
        {
            GameManager_193319.instance.PlayerReachedEnd();
    ...
    {
        GameManager_193319.instance.AddLives(1);
    }
    ...
    private void Update()
    {
        if (GameManager_193319.instance.currentGameState_193319 != GameState_193319.GS_GAME) return;
